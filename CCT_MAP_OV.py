...
def run_version_1_a():
    ...
    model_paths_OV = [
        ...
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_EE_5_2.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_EE_5_1.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_EE_5_0.pkl"
    ]
    ...
    df_group_OV.to_csv("/home/jovyan/OfficialTutorials/For_Linux/figures_dir_OV/OV_replication_EE_5/group_level_MAP_table_EE_OV_m5.csv", index=False)
    ...
    df_combined_OV.to_csv("/home/jovyan/OfficialTutorials/For_Linux/figures_dir_OV/OV_replication_EE_5/combined_parameter_comparison_table_EE_OV_m5.csv", index=False)
...
#    
#    model_paths = [
#        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_EE_1_4.pkl",
#        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_EE_1_3.pkl",
#        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_EE_1_2.pkl",
#        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_EE_1_1.pkl",
...
#    df_group.to_csv("/home/jovyan/OfficialTutorials/For_Linux/figures_dir_OV/OV_replication_EE_1/group_level_MAP_table_EE_OV_m1.csv", index=False)
#    print("Group-level parameter estimates:")
#    print(df_group)
...
def run_version_1_b():
    ...
    # load and combine OV model files (set which model)
    model_paths_OV_4 = [
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ES_6_4.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ES_6_3.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ES_6_2.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ES_6_1.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ES_6_0.pkl"
    ]
    ...
    vIA_OV    = combinedModels_OV_4.nodes_db.node['v_InattentionW']
    vA_low  = combinedModels_OV_4.nodes_db.node['v_AttentionW:C(OVcate)[low]']
    vA_med  = combinedModels_OV_4.nodes_db.node['v_AttentionW:C(OVcate)[medium]']
    vA_high = combinedModels_OV_4.nodes_db.node['v_AttentionW:C(OVcate)[high]']
    
    # Group-level Table for OV (theta = b2 / b1 per OV level)
    theta_low  = vIA_OV.trace() / vA_low.trace()
    theta_med  = vIA_OV.trace() / vA_med.trace()
    theta_high = vIA_OV.trace() / vA_high.trace()
    ...
    group_params_OV_4 = {
        ...
        "a(high)": a_high.trace(),
        "v_Intercept": inter_OV.trace(),
        "v_InattentionW": vIA_OV.trace(),
        "v_AttentionW:C(OVcate)[low]": vA_low.trace(),
        "v_AttentionW:C(OVcate)[medium]": vA_med.trace(),
        "v_AttentionW:C(OVcate)[high]": vA_high.trace(),
        "theta(low)": theta_low,
        "theta(medium)": theta_med,
        "theta(high)": theta_high
    }
    ...
    df_group_OV_4.to_csv("/home/jovyan/OfficialTutorials/For_Linux/figures_dir_OV/OV_replication_ES_6/group_level_MAP_table_OV_ES_m6.csv", index=False)
    print("group-level parameter estimates:")
    print(df_group_OV_4)
    ...
    rows_OV_4.append({
        "Parameter": "b1",
        "Group-level": format_estimate(vIA_OV.trace()),
        "Med-Low": "",
        "High-Low": "",
        "High-Med": ""
    })
    ...
    df_combined_OV_4.to_csv("/home/jovyan/OfficialTutorials/For_Linux/figures_dir_OV/OV_replication_ES_6/combined_parameter_comparison_table_OV_ES_m6.csv", index=False)
    print("OV Combined Parameter Comparison Table:")
...
def run_version_1_c():
    ...
    # load and combine OV model files (set which model)
    model_paths_OV = [
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ES_7_4.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ES_7_3.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ES_7_2.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ES_7_1.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ES_7_0.pkl"
    ]
    ...
    t_high   = combinedModels_OV.nodes_db.node['t(high)']
    inter_OV = combinedModels_OV.nodes_db.node['v_Intercept']
    vIA_OV    = combinedModels_OV.nodes_db.node['v_InattentionW']
    vA_low  = combinedModels_OV.nodes_db.node['v_AttentionW:C(OVcate)[low]']
    vA_med  = combinedModels_OV.nodes_db.node['v_AttentionW:C(OVcate)[medium]']
    vA_high = combinedModels_OV.nodes_db.node['v_AttentionW:C(OVcate)[high]']
    ...
    df_group_OV = pd.DataFrame(group_results_OV)
    df_group_OV.to_csv("/home/jovyan/OfficialTutorials/For_Linux/figures_dir_OV/OV_replication_ES_7/group_level_MAP_table_ES_OV_m7.csv", index=False)
    print("group-level parameter estimates:")
    print(df_group_OV)
    ...
    df_combined_OV = pd.DataFrame(rows_OV, columns=["Parameter", "Group-level", "Med-Low", "High-Low", "High-Med"])
    df_combined_OV.to_csv("/home/jovyan/OfficialTutorials/For_Linux/figures_dir_OV/OV_replication_ES_7/combined_parameter_comparison_table_ES_OV_m7.csv", index=False)
    print("OV Combined Parameter Comparison Table:")
    print(df_combined_OV)
...
#    model_paths = [
#        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ES_1_4.pkl",
#        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ES_1_3.pkl",
#        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ES_1_2.pkl",
#        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ES_1_1.pkl",
#        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ES_1_0.pkl"
#    ]
#    
#    models = []
#    for path in model_paths:
...
#    
#    df_group = pd.DataFrame(group_results)
#    df_group.to_csv("/home/jovyan/OfficialTutorials/For_Linux/figures_dir_OV/OV_replication_ES_1/group_level_MAP_table_ES_OV_m1.csv", index=False)
#    print("Group-level parameter estimates:")
#    print(df_group)
...
def run_version_2_a():
    ...
    model_paths_m4 = [
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ESEE_4_4.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ESEE_4_3.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ESEE_4_2.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ESEE_4_1.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ESEE_4_0.pkl"
    ...
    df_group_m4.to_csv("/home/jovyan/OfficialTutorials/For_Linux/figures_dir_OV/OV_replication_ESEE_4/group_level_MAP_table_OV_ESEE_m4.csv", index=False)
    ...
    df_combined_m4.to_csv("/home/jovyan/OfficialTutorials/For_Linux/figures_dir_OV/OV_replication_ESEE_4/combined_parameter_comparison_table_OV_ESEE_m4.csv", index=False)
    print("Model 4 Combined Parameter Comparison Table (ESEE):")
    print(df_combined_m4)
    
    # MODEL 1, ESEE (baaseline model)
#    model_paths_m1 = [
#        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ESEE_1_4.pkl",
#        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ESEE_1_3.pkl",
#        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ESEE_1_2.pkl",
#        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ESEE_1_1.pkl",
#        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ESEE_1_0.pkl",
#    ]
#    
#    models_m1 = []
...
#    df_group_m1.to_csv("/home/jovyan/OfficialTutorials/For_Linux/figures_dir_OV/OV_replication_ESEE_1/group_level_MAP_table_OV_ESEE_m1.csv", index=False)
...
def run_version_2_b():
    ...
    # MODEL 5 or 4 (best fitting ones) , ESEE (Phase-specific model: ES and EE)
    model_paths_m5 = [
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ESEE_5_4.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ESEE_5_3.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ESEE_5_2.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ESEE_5_1.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV/OV_replication_ESEE_5_0.pkl",
    ]
    ...
    df_group_m5.to_csv("/home/jovyan/OfficialTutorials/For_Linux/figures_dir_OV/OV_replication_ESEE_5/group_level_MAP_table_OV_ESEE_m5.csv", index=False)
    ...
    df_combined_m5.to_csv("/home/jovyan/OfficialTutorials/For_Linux/figures_dir_OV/OV_replication_ESEE_5/combined_parameter_comparison_table_OV_ESEE_m5.csv", index=False)
...
"""def run_version3():
    ...
    model_paths = [
        "/home/jovyan/OfficialTutorials/For_Linux/model_dir_OV/OV_replication_LEESEE_5_2.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/model_dir_OV/OV_replication_LEESEE_5_1.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/model_dir_OV/OV_replication_LEESEE_5_0.pkl"
    ]
    ...
    df_group = pd.DataFrame(group_results)
    df_group.to_csv("/home/jovyan/OfficialTutorials/For_Linux/figures_dir_OV_CCT/OV_replication_LEESEE_5/group_level_MAP_table_mod5.csv", index=False)
    print("Group-level parameter estimates:")
    print(df_group)
    ...
    df_combined.to_csv("/home/jovyan/OfficialTutorials/For_Linux/figures_dir_OV/OV_replication_LEESEE_5/combined_parameter_comparison_table_m5.csv", index=False)
    print("Combined Parameter Comparison Table:")
    print(df_combined)
    
    # For model 1 (baseline model) with LE, ES, EE
    model_paths = [
        "/home/jovyan/OfficialTutorials/For_Linux/model_dir_OV/OV_replication_LEESEE_1_2.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/model_dir_OV/OV_replication_LEESEE_1_1.pkl",
        "/home/jovyan/OfficialTutorials/For_Linux/model_dir_OV/OV_replication_LEESEE_1_0.pkl"
    ]
    ...
    df_group = pd.DataFrame(group_results)
    df_group.to_csv("/home/jovyan/OfficialTutorials/For_Linux/figures_dir_OV/OV_replication_LEESEE_1/group_level_MAP_table_mod1.csv", index=False)
    print("Group-level parameter estimates:")
    print(df_group) """
