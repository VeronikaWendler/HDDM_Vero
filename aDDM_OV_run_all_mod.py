...
# ------------------------------------------------------------------
# BATCH-RUN CONTROL
PHASE_RUN_ORDER = ["ESEE"]                                     # order
SKIP_PHASES     = {"ES","EE", "LE", "LEESEE"}                 # ignored this phase
...
# dir
BASE_MODEL_DIR = '/home/jovyan/OfficialTutorials/For_Linux/models_dir_OV'
...
if __name__ == "__main__":
    ...
    for phase in PHASE_RUN_ORDER:
        ...
        for version, model_name in enumerate(model_versions[phase]):
            ...
            fig_dir = os.path.join("figures_dir_OV", full_model_name)
            ensure_dir(os.path.join(fig_dir, "diagnostics"))
