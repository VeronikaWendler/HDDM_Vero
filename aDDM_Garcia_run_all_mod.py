...
model_versions  = {
    ...
    "For_paper": ["For_paper_1","For_paper_2","For_paper_3","For_paper_4","For_paper_5","For_paper_6","For_paper_7","For_paper_8","For_paper_9","For_paper_10","For_paper_11", "For_paper_12", "For_paper_13", "For_paper_14", "For_paper_15", "For_paper_16", "For_paper_17"],
}
...
def run_model(trace_id, data, model_dir, model_name, version, phase, samples=6000, accuracy_coding=True): 
    ...
    if phase == 'LE':
        ...
        # z included
            ...
            v_reg = {'model': 'v ~ 0 + ES_AttentionW + IAW_chart + IAW_image', 'link_func': lambda x: x}
            reg_descr = [v_reg]
        else:
            raise ValueError(f"Invalid version {version}")
