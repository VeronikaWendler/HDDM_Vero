...
model_versions = {
    ...
    'ES': ['ES_1', 'ES_2', 'ES_3', 'ES_4','ES_5', 'ES_6', 'ES_7', 'ES_8', 'ES_9', 'ES_10', 'ES_11','ES_12', 'ES_13', 'ES_14', 'ES_15', 'ES_16', 'ES_17', 'ES_18', 'ES_19','ES_20', 'ES_21', "ES_22", "ES_23", "ES_24", "ES_25", "ES_26", "ES_27","ES_28"],   
    ...
    if phase == 'LE':
        ...
        if version == 0:
            ...
            params_of_interest = [
                ...
                "t_abs_DwellPropAdv:C(OVcate)[high]",
                ]
            params_of_interest_s = [p + "_subj" for p in params_of_interest]
            titles = [
                "Boundary sep."
                ...
                "Drift DwellPropAdvantage",
                "Drift gaze_quad",
                "Drift · abs DwellPropAdv (low OV)",
                "Drift · abs DwellPropAdv (med OV)",
                "Drift · abs DwellPropAdv (high OV)",
                "ndt intercept",
                "ndt · abs DwellPropAdv (low OV)",
                "ndt · abs DwellPropAdv (med OV)",
                "ndt · abs DwellPropAdv (high OV)",
                ]
