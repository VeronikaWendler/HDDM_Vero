...
recovered_nc = os.path.join(BASE_MODEL_DIR, "mES_31_recovery.nc")
...
csv_filename = FIG_DIR_ROOT / "parameter_recovery_summary_ES_31.csv"
...
# f.legend(handles, labels, loc='lower center', bbox_to_anchor=(0.5, -0.05), ncol=2)
# plt.tight_layout()
# plot_path = os.path.join(FIG_DIR_ROOT, "Posterior_dens_fitted_recov_2.png")
# plt.savefig(plot_path, dpi=300, bbox_inches='tight')
# plt.show()
...
# ax.set_title("Comparison of Fitted and Recovered Parameters")
# # IMPORTANT - make sure this fits the model and path
# plot_path2 = os.path.join(FIG_DIR_ROOT, "Forest_plot_group_2.png")
...
# # CSV
# summary_df = pd.DataFrame(summary_data)
# csv_filename = FIG_DIR_ROOT / "parameter_recovery_summary_ES_27_nr2.csv"
# summary_df.to_csv(csv_filename, index=False)
# print(f"Summary exported to {csv_filename}")
...
# plt.tight_layout()
# plot_path3 = os.path.join(FIG_DIR_ROOT, "Reg_plots_2.png")
...
# # getting the recovered data
# recovered_nc = os.path.join(BASE_MODEL_DIR, "mES_29_recovery_nr2.nc")
# m_recovery_infdata = az.from_netcdf(recovered_nc)
...
# # CSV
# summary_df = pd.DataFrame(summary_data)
# csv_filename = FIG_DIR_ROOT / "parameter_recovery_summary_ES_29.csv"
# summary_df.to_csv(csv_filename, index=False)
# print(f"Summary exported to {csv_filename}")
