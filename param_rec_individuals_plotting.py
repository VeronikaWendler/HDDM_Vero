...
OUT_PNG     = FIG_DIR / "scatter_individual_ALL_params2.png"
OUT_STATS   = FIG_DIR / "scatter_individual_ALL_params_stats2.csv"
...
# order panels: put key ones first if present
...
def regress_stats(x, y):
    ...
    return dict(
        ...
        p_beta_eq1=float(p_eq1),
        intercept=float(res.intercept),
        R2=r2, RMSE=rmse
    )

# compute and save a stats table
stats_rows = []
for p in params:
